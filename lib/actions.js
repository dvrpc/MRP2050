...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Federal and State<br>Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2017 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.PresCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    // +"<table class='infotable'><thead><tr><th>State and Local <br>Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Federal New Starts /<br>Core Capacity<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2017 $)</i></th></tr></thead>"
    ...
    // +"</table><div class='labelfield'>Funding</div>"
    +"<table class='infotable'><thead><tr><th>State and Local <br>Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2017 $)</i></th></tr></thead>"
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>State and Local<br><i>(millions in Y-O-E $)</i></th><th>Federal New Starts /<br>Core Capacity<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2017 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.ExpCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.External_C).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
