...
function highlightLayer8pt(e) {
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Total External Cost<br><i>(millions in Y-O-E $)</i></th></tr></thead>"
...
function highlightLayer8(e) {
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Total Extrernal Cost<br><i>(millions in Y-O-E $)</i></th></tr></thead>"
    + EXT
    +"</table><div class='labelfield'>Funding</div>"
 //   + TIP
