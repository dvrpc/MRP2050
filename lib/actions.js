...
function highlightLayer3(e) {
 ...
 //   header = '<div style="color:white;background-color:'+props.BanColor+'"><span id="infoheader-text"><img style="margin:0px 0px 0px 6px" src="'+ props.TYPE_IMG+ '"/>&nbsp;&nbsp;' + props.FACILITY + '</span></div>',
    ...
    + Website 
    +"<table class='infotable'><thead><tr><th>TIP Programmed Costs<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.TTCost).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.TTCost).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
...
function highlightLayer1(e) {
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>System Expansion Cost<br><i>(millions in Y-O-E $)</i></th><th>Total Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.ExpCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.TTCost).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
    +"</div>"
    +"<div class='datafield' id='"+props.CATGROUP+"'style='color:#fff;padding:6px'>" + props.CATEGORY 
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>State and Local Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Federal New Starts / <br>Small Starts<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.ExpCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.External_C).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
  //  +TIP2a
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><span id="infoheader-text"><img style="margin:0px 0px 0px 6px" src="'+ props.TYPE_IMG+ '"/>&nbsp;&nbsp;' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Local, Private, and Other Funded<br><i>(millions in Y-O-E $)</i></th><th>State and Federal Funded<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.External_C).format('($0,0.0)') +"</td><td> "+ numeral(props.BPCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
    +"</div>"
    +"<div class='datafield' id='"+props.CATGROUP+"'style='color:#fff;padding:6px'>" + props.CATEGORY 
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Federal and State Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.PresCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
    +"<div class='datafield' id='"+props.CATGROUP+"'style='color:#fff;padding:6px'>" + props.CATEGORY 
    +"</div>",
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>Federal and State<br>Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.PresCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    // +"</table><div class='labelfield'>Funding</div>"
    +"<table class='infotable'><thead><tr><th>State and Local <br>Funded Cost<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.OpCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
  //  +TIP2a
...
//    header = '<div style="color:white;background-color:'+props.BanColor+'"><img style="margin:0px 0px 0px 10px !important;" src="'+ props.TYPE_IMG+ '"/><span id="infoheader-text">' + props.FACILITY + '</span></div>',
    ...
    +"<div class='datafield'>" + props.Timing + "</div><div class='labelfield'>Timing</div>"
    + Website 
    +"<table class='infotable'><thead><tr><th>State and Local<br><i>(millions in Y-O-E $)</i></th><th>Federal New Starts /<br>Core Capacity<br><i>(millions in Y-O-E $)</i></th><th>Unfunded Cost<br><i>(millions in 2021 $)</i></th></tr></thead>"
    +"<tbody><tr><td> "+ numeral(props.ExpCosts).format('($0,0.0)') +"</td><td> "+ numeral(props.External_C).format('($0,0.0)') +"</td><td> "+ numeral(props.Unfund_Ill).format('($0,0.0)') +"</td></tr></tbody>"
    +"</table><div class='labelfield'>Funding</div>"
    + TIP
  //  +TIP1a
