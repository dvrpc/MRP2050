...
(function (window, document, undefined) {
    ...
    L.createLegend = function (options) {
        ...
        window['DynaTitle' + options.layer] = ''+options.titleicon +' ' +options.title+'';
        if(options.legendMarker === 'checkbox'){
             $('#' + options.layer + '.dyna').wrap('<div class="checkbox" data-toggle="tooltip" title="Click to toggle layer"></div>').after('<label for="' + options.layer + '" class="dynacheck"><div class="legend-check"><i class="dynico dynico-square-o"></i></div> '+ options.titleicon + options.title+'</label>');
        }else{
